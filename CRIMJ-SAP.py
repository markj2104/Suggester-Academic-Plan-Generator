...
legend_elements = [
    plt.Line2D([0], [0], marker='s', color='w', label='Core', markerfacecolor='blue', markersize=15),
    plt.Line2D([0], [0], marker='s', color='w', label='Gen Ed', markerfacecolor='pink', markersize=15),
    plt.Line2D([0], [0], marker='s', color='w', label='Major & Gen Ed', markerfacecolor='purple', markersize=15),
    plt.Line2D([0], [0], marker='s', color='w', label='Elective', markerfacecolor='yellow', markersize=15),
]
